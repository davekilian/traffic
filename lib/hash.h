...
typedef unsigned int (*tr_equalfunc)(const void *a, const void *b); // a == b

unsigned int tr_hashfunc_str(const void *str);
unsigned int tr_hashfunc_int(const void *num);

unsigned int tr_equalfunc_str(const void *str1, const void *str2);
unsigned int tr_equalfunc_int(const void *num1, const void *num2);
...
unsigned int tr_hash_contains(tr_hash hash, const void *key);
